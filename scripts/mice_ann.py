...
class NeuralNet(nn.Module):
    def __init__(self):
        ...
        self.linears.append(nn.Linear((dim+p), 8))
...
np.savetxt('./mice-results/used_weights_ann'  +'.txt',used_weights, delimiter=',',fmt='%s')
np.savetxt('./mice-results/ens_ann' +'.txt',ens_, delimiter=',',fmt='%s')
np.savetxt('./mice-results/med_ann' +'.txt',median_, delimiter=',',fmt='%s')
np.savetxt('./mice-results/avg_length_ann' +'.txt',path_length, delimiter=',',fmt='%s')
np.savetxt('./mice-results/max_length_ann' +'.txt',max_length, delimiter=',',fmt='%s')

np.savetxt('./mice-results/ece_ann' +'.txt',eces, delimiter=',',fmt='%s')
np.savetxt('./mice-results/ecempm_ann' +'.txt',eces_mpm, delimiter=',',fmt='%s')
np.savetxt('./mice-results/lik_ann' +'.txt',lik, delimiter=',',fmt='%s')
np.savetxt('./mice-results/likmpm_ann' +'.txt',lik_mpm, delimiter=',',fmt='%s')
