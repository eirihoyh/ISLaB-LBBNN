...
res = {}
data = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_50_dim_200_epochs_0.1_lr_WBC_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_50_dim_200_epochs_0.1_lr_WBC_sigmoid_median.txt", delimiter=",")
