...
path = "implementations/lrt/fer2013/"
...
res = {}
data = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_200_dim_10000_epochs_0.005_lr_fer2013_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_200_dim_10000_epochs_0.005_lr_fer2013_sigmoid_median.txt", delimiter=",")
