...
path = "implementations/lrt/abalone/"
...
res = {}
data = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_200_dim_5000_epochs_0.01_lr_abalone_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_200_dim_5000_epochs_0.01_lr_abalone_sigmoid_median.txt", delimiter=",")
