...
path = "implementations/lrt/linear_problem/"
...
res = {}
for d in dep_levels:
    data = np.loadtxt(path+f"results/lrt_class_skip_4_hidden_20_dim_200_epochs_0.1_lr_lin_func_dep_level_{d}_sigmoid_full.txt", delimiter=",")
    data_median = np.loadtxt(path+f"results/lrt_class_skip_4_hidden_20_dim_200_epochs_0.1_lr_lin_func_dep_level_{d}_sigmoid_median.txt", delimiter=",")
    res[d] = {}
