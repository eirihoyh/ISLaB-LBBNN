...
res = {}
data = np.loadtxt(path+f"results/lrt_class_skip_4_hidden_100_dim_2000_epochs_0.01_lr_mice_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/lrt_class_skip_4_hidden_100_dim_2000_epochs_0.01_lr_mice_sigmoid_median.txt", delimiter=",")
