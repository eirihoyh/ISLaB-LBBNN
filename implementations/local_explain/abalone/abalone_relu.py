...
for ni in range(n_nets):
    ...
    if save_res:
        torch.save(net, f"implementations/local_explain/abalone/network/net{ni}")
    all_nets[ni] = net 
    # Results
    ...
    pf.run_path_graph(all_nets[ni], threshold=0.5, save_path=f"implementations/local_explain/abalone/path_graphs/prob/net{ni}_relu", show=False)
    pf.run_path_graph_weight(net, save_path=f"implementations/local_explain/abalone/path_graphs/weight/net{ni}_relu", show=False)
...
print(f"True output value: {output_val}")
