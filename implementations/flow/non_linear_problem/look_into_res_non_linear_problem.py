...
res = {}
for d in dep_levels:
    data = np.loadtxt(path+f"results/flow_class_skip_4_hidden_20_dim_500_epochs_0.01_lr_non_lin_func_dep_level_{d}_sigmoid_full.txt", delimiter=",")
    data_median = np.loadtxt(path+f"results/flow_class_skip_4_hidden_20_dim_500_epochs_0.01_lr_non_lin_func_dep_level_{d}_sigmoid_median.txt", delimiter=",")
    res[d] = {}
