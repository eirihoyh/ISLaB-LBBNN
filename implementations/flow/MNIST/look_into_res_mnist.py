...
path = "implementations/flow/MNIST/"
...
res = {}
data = np.loadtxt(path+f"results/flow_class_skip_2_hidden_600_dim_1000_epochs_0.005_lr_mnist_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/flow_class_skip_2_hidden_600_dim_1000_epochs_0.005_lr_mnist_sigmoid_median.txt", delimiter=",")
