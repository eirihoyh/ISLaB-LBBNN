...
# Get linear data
X_test_original = np.loadtxt("data/WBC/X_test.txt", delimiter=",")
y_test_original = np.loadtxt("data/WBC/Y_test.txt", delimiter=",")
...
res = {}
data = np.loadtxt(path+f"results/flow_class_skip_2_hidden_50_dim_200_epochs_0.05_lr_WBC_sigmoid_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/flow_class_skip_2_hidden_50_dim_200_epochs_0.05_lr_WBC_sigmoid_median.txt", delimiter=",")
