...
path = "implementations/lrt/MNIST/"
...
res = {}
data = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_600_dim_5000_epochs_0.01_lr_mnist_sigmoid_dense_init_full.txt", delimiter=",")
data_median = np.loadtxt(path+f"results/lrt_class_skip_2_hidden_600_dim_5000_epochs_0.01_lr_mnist_sigmoid_dense_init_median.txt", delimiter=",")
